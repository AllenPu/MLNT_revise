...
tch_net = PreResNet.ResNet18(num_class)
tch_net.fc = nn.Linear(2048,num_class)
###
###
###
...
#
#
pretrain_net = PreResNet.ResNet18(num_class)
#14
pretrain_net.fc = nn.Linear(2048,num_class)
